...
public class GameSetupController : MonoBehaviourPun
{
    ...
    private void CreatePlayer() {  
        if(PhotonNetwork.IsConnected) {
            ...
            Instantiate(varPrefab, new Vector3(-30, -7, 0), Quaternion.identity);
             Object varPrefab2 = Resources.Load("Prefabs/Characters/green", typeof(GameObject));
            Instantiate(varPrefab2, new Vector3(-28, -7, 0), Quaternion.identity);
             Object varPrefab3 = Resources.Load("Prefabs/Characters/blek", typeof(GameObject));
            Instantiate(varPrefab3, new Vector3(-26, -7, 0), Quaternion.identity);
             Object varPrefab4 = Resources.Load("Prefabs/Characters/blue", typeof(GameObject));
            Instantiate(varPrefab4, new Vector3(-24, -7, 0), Quaternion.identity);
