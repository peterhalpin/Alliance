...
{
    [SerializeField]
    public GameObject quickStartButton; //button used for creating and joining a game.
    [SerializeField]
    public GameObject quickCancelButton; //button used to stop searing for a game to join.
    [SerializeField]
